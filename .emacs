...
(custom-set-variables
 ...
 '(flycheck-clang-include-path (quote ("./" "./includes/" "../includes/" "./include/" "../include/" "/nfs/zfs-student-5/users/2014/ntibi/.brew/Cellar/boost/1.58.0/include/" "/data/include/")))
 ...
 '(safe-local-variable-values (quote ((semantic-add-system-include "/nfs/zfs-student-5/users/2014/ntibi/.brew/include/") (eval when (fboundp (quote aggressive-indent-mode)) (aggressive-indent-mode -1)) (eval when (fboundp (quote rainbow-mode)) (rainbow-mode 1)) (company-clang-arguments "-I/nfs/zfs-student-5/users/2014/ntibi/.brew/Cellar/boost/1.58.0/include/") (company-clang-arguments "-I/nfs/zfs-student-5/users/2014/ntibi/.brew/include/boost"))))
 '(tabbar-separator (quote (0.5)))
 '(vc-annotate-background "#3b3b3b")
 '(vc-annotate-color-map (quote ((20 . "#dd5542") (40 . "#CC5542") (60 . "#fb8512") (80 . "#baba36") (100 . "#bdbc61") (120 . "#7d7c61") (140 . "#6abd50") (160 . "#6aaf50") (180 . "#6aa350") (200 . "#6a9550") (220 . "#6a8550") (240 . "#6a7550") (260 . "#9b55c3") (280 . "#6CA0A3") (300 . "#528fd1") (320f . "#5180b3") (340 . "#6380b3") (360 . "#DC8CC3"))))
